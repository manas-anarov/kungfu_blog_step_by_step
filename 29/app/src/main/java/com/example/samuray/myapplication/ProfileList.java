...
public class ProfileList extends Fragment{
    ...
    private void showAllPosts() {
        ...
        Call<List<PostModel>> call = postApi.getProfileList(queryToken_ap);
            ...
            public void onResponse(Call<List<PostModel>> call, Response<List<PostModel>> response) {
                ...
                if(response.isSuccessful()){
                    ...
                    if (response.body() != null) {
                        List<PostModel> profileList = response.body();

                        for(PostModel h:profileList){
    ...
    private void initRecyclerView(){
        ...
        RecyclerProfileList adapter = new RecyclerProfileList(getActivity(), pkPost, namePost);
